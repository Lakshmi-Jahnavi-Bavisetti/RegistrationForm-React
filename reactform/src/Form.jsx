...
export default function Form() {
 ...
 function fun2(){
  ...
  return (
    ...
    <div className=" flex flex-row flex-nowrap justify-evenly pl-8 pt-4 pr-2">
    <label id="email" className='text-white pt-3 '>Email: </label>
      <input type="email" id="emailinput" onChange={cemail} autoComplete="off" value={email} name="useremail" placeholder="xyz@gmail.com" className='border rounded-md border-stone-800 pl-2 mr-9 pr-4' required />
    </div>
    <div className=" pl-8 pt-4">
    
        <label id="phone" className='text-white'>Phone: </label>
      <input type="number" id="phoneinput" autoComplete='off' value={phone || ""} onChange={cphone} placeholder="xxxxxxxxxx" className='border rounded-md border-stone-800 pl-2 mr-12 pr-4'  required />
